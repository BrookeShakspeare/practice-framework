    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
      ...
      <div style={{ padding: "14px 18px", backgroundColor: "white", borderRadius: "12px", border: `1px solid ${T.lineFaint}` }}>
        ...
        <p style={{ margin: 0, fontFamily: "Georgia, serif", fontSize: "12.5px", color: T.inkFaint, lineHeight: 1.7 }}>
          The Practice Map is a collaborative work developed by <strong style={{ color: T.inkMid }}>Brooke Shakspeare</strong>, social worker, clinical supervisor and educator, in collaboration with <strong style={{ color: T.inkMid }}>Dr Leonie White</strong>, psychologist, family therapist, supervisor and Director of Phoenix Family Therapy Academy and Therapywell Allied Health and Wellbeing.
